...
public class CharacterController2dNoCrouch : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		feet = gameObject.GetComponentsInChildren<Collider>();
	}
	...
	public void Move(float move, bool blank, bool jump)
	{
